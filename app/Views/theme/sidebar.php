...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo site_url('admin/users/register');?>">New User</a>
            <a class="collapse-item" href="<?php echo site_url('admin/users');?>">Lists of Users</a>
        </div>
    </div>
</li>
...
<div class="sidebar-card d-none d-lg-flex">
    <img class="sidebar-card-illustration mb-2" src="/themes/sb-admin-2-gh-pages//img/undraw_rocket.svg" alt="...">
