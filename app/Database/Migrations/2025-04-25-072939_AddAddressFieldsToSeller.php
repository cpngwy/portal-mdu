...
class AddAddressFieldsToSeller extends Migration
{
    public function up()
    {
        $this->forge->addColumn('sellers', [
    ...
    {
        $this->forge->dropColumn('sellers', ['country_code', 'city', 'state', 'zip_code', 'address_line1']);
    }
}
